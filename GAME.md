...
- **Last updated:** 2026-09-07 by Cursor (airfield props densify)
- **Branch / working tree:** `cursor/authored-fbx-turboprop-terminal-8515` (PR #131)
- **Do this next:** Continue 0025 — Addressables/DCC path, more env/HUD fidelity. No new economy. Do not block on Mac playtest.
- **In progress / half-done:** Airfield props kit ~55 (dolly bags, sock segments, barrier braces, sign glyphs); parked GA/car densified. Still ~20% of REF.
