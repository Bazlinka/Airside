...
- **Last updated:** 2026-09-07 by Cursor (night glow flicker + hold-short)
- **Branch / working tree:** `cursor/authored-fbx-turboprop-terminal-8515` (PR #131)
- **Do this next:** Continue 0025 — kit fidelity, HUD polish, or further env/atmosphere. No new economy systems.
- **In progress / half-done:** Authored kits; wet/day/env/motion polish; night window flicker; hold-short C/D + emission; TDZ marks.
...
- **Visual assets:** Authored Batch C set + lighting/props; night readability pass on presentation track.