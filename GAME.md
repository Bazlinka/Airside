...
- **Last updated:** 2026-09-07 by Cursor (materials + apron life)
...
- **In progress / half-done:** Authored kits densified across Batch C; fence/HUD/wet/day/stars; retuned URP dry profiles; denser apron figures + flood contact shadows. Still far from REF (~20% baseline).
- **Watch out for:** Flood/star/cloud/puddle/fence/figure count vs Mac Play perf; ClearCoat no-op on older URP; preserve art .meta GUIDs when regenerating.
