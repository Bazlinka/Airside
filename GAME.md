...
- **Last updated:** 2026-09-07 by Cursor (glTF UVs + kit materials)
- **Branch / working tree:** `cursor/gltf-kit-uvs-materials-ddad` (+ open #51–#53)
- **Do this next:** Merge open presentation PRs; continue lighting/HUD Toolkit later.
  Bailey Play soak when convenient — do not block.
- **In progress / half-done:** planar UVs + building surface textures on this branch.
- **Watch out for:** Merge conflicts likely with #51/#52 on `AirsidePrototype` —
  keep PreferArtKit + environment helpers when resolving.
- **Open questions for Bailey:** none.
- **Visual assets:** brand Integrated; env/v02/HUD/UVs pending merge; Play Bailey-owned
...
1. **Merge open presentation PRs** (#51 environment, #52 Batch C v02, #53 HUD,
   this UV/materials branch).
2. **Lighting / HUD Toolkit later** (0025 items 5–6) after merges settle.
3. **Bailey Unity Play soak** when convenient — do not block. No new economy
