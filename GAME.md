...
- **Last updated:** 2026-09-07 by Cursor (apron safety props)
- **Branch / working tree:** `cursor/apron-safety-props-ddad`
- **Do this next:** Merge this PR; Bailey Play soak hydrants/cabinets/FOD bins + stand boxes; authored FBX still the real visual bar
- **In progress / half-done:** 20 Resources prefabs after this PR; sand/water PBR on main; authored FBX + Editor Addressables still open
...
- **Visual assets:** Batch C v04; landside + apron safety prefabs; coast PBR; Toolkit HUD
