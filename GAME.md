...
- **Last updated:** 2026-09-07 by Cursor (vehicles + life + URP tip)
- **Branch / working tree:** `cursor/authored-fbx-turboprop-terminal-8515` (PR #131)
- **Do this next:** Continue 0025 — props/ops fidelity, more motion, presentation bugs, further env/URP polish. No new economy. Do not block on Mac playtest.
- **In progress / half-done:** Fuel truck 47 / tug 45 / bus 46 / service kit 48 meshes; denser apron figures + birds + trees; URP dry profiles retuned. Kits from prior tips still in place. Still far from REF (~20% baseline).
