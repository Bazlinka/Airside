...
- **Last updated:** 2026-09-07 by Cursor (terminal densify + HUD chrome tip)
- **Branch / working tree:** `cursor/authored-fbx-turboprop-terminal-8515` (PR #131)
- **Do this next:** Continue 0025 — more vehicle/kit fidelity, motion/life, presentation bugs, further URP/env polish. No new economy. Do not block on Mac playtest.
- **In progress / half-done:** Turboprop 102 + terminal 73 meshes; coast/wet/day from prior tip; HUD Open Sky top accent + save-chip chrome; terminal flag flap. Still far from REF (~20% baseline).
