...
|---|---|---|---|
| AIR-001 | `Models/Aircraft/mdl_atr42_starter_v03.gltf` (+ `.bin`; `.fbx` editable source; v02/v01/v06 fallback) | Fictional ATR 42-600-class regional turboprop at 22.67 × 24.57 × 7.59 m: stocky high-wing fuselage with four curvature-fitted cockpit panes and credible pillars, even cabin windows, compact nacelles blended into the wing, fuselage-side main-gear sponsons, a joined T-tail with broader saddle, and six 3.93 m props; 183 named parts / 19,704 triangles; same envelope and moving-part names as v02 | Integrated for Emu Air / player under ADR 0051; 2026-09-15 controlled fidelity and close-view pass as v03 (v02 retained fallback); Hangar thumbnail regenerated; packaged overview/follow day/dusk/night QA pending |
...
| AIR-005 | `Models/Aircraft/mdl_737_8_narrowbody_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded 737-8-class narrowbody at real reference scale: slender fuselage with fitted cabin glazing, a skin-coloured flight-deck crown with three compact panes, low swept wing with restrained split winglets, large forward-hung turbofans with chevron nozzles, tapered wing-body fairing, joined conventional tail and tricycle gear; 199 named parts / 17,404 triangles; dedicated pick, shadow and follow framing profile | Integrated as the operational AI 737-8 VH-WTJ (fictional Wattlebird Jet) at Gate 13 under ADR 0047; 2026-09-15 close-view polish in place (same path); Hangar thumbnail regenerated; packaged camera QA pending |
| AIR-006 | `Models/Aircraft/mdl_dash8_q400_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Dash 8-400-class regional turboprop at 32.83 × 28.42 × 8.34 m: long high-wing fuselage with fitted cabin glazing and framed flight deck, continuous nacelles with rounded main-gear bays and thin open doors, pitched six-blade props, continuous wing-root saddle, tip fences and joined T-tail; 182 named parts / 27,288 triangles; dedicated pick, shadow and follow framing profile | Integrated for QantasLink under ADR 0049; 2026-09-15 visual quality and nacelle-bay pass in place (same path); Hangar thumbnail regenerated; packaged overview/follow day/dusk/night QA pending |
| AIR-007 | `Models/Aircraft/mdl_saab_340b_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Saab 340B-class regional turboprop at 19.73 × 21.44 × 6.97 m (standard wing): compact low wing, narrow fuselage, rounded flight deck with four fitted panes, conventional tail, four-blade Dowty props with compact hubs, nacelle-mounted twin main gear with curved bay fairings; 120 named parts / 6,868 triangles; dedicated pick, shadow and follow framing profile | Integrated for Rex's existing Saab 340Bs under ADR 0050; 2026-09-15 close-view polish in place (same path); own 480 × 320 runtime-model thumbnail; packaged overview/follow day/dusk/night QA pending |
