...
| AIR-006 | `Models/Aircraft/mdl_dash8_q400_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Dash 8-400-class regional turboprop at 32.83 × 28.42 × 8.34 m: long high-wing fuselage with fitted cabin glazing and framed flight deck, continuous nacelles with main-gear bays, pitched six-blade props, continuous wing-root saddle, tip fences and joined T-tail; 182 named parts / 26752 triangles; dedicated pick, shadow and follow framing profile | Integrated for QantasLink under ADR 0049; 2026-09-15 visual quality pass in place (same path); Hangar thumbnail regenerated; packaged overview/follow day/dusk/night QA pending |
