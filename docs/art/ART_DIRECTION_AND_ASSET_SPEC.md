...
| AIR-006 | `Models/Aircraft/mdl_dash8_q400_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Dash 8-400-class regional turboprop at 32.83 × 28.42 × 8.34 m: long high-wing fuselage with fitted cabin glazing and pitched flight deck, continuous nacelles with main-gear bays, six-blade propellers, tip fences and joined T-tail; 174 named parts / 18,856 triangles; dedicated pick, shadow and follow framing profile | Integrated for QantasLink under ADR 0049; 2026-09-15 visual revision in place (same path); Hangar thumbnail regenerated; packaged overview/follow day/dusk/night QA pending |
