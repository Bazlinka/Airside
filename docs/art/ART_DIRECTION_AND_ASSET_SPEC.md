...
| AIR-007 | `Models/Aircraft/mdl_saab_340b_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Saab 340B-class regional turboprop at 19.73 × 21.44 × 6.97 m (standard wing): compact low wing, narrow fuselage, conventional tail, four-blade Dowty props, nacelle-mounted twin main gear; 124 named parts / 6,620 triangles; dedicated pick, shadow and follow framing profile | Integrated for Rex's existing Saab 340Bs under ADR 0050; own 480 × 320 runtime-model thumbnail; packaged overview/follow day/dusk/night QA pending |
