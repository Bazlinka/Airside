...
|---|---|---|---|
| AIR-001 | `Models/Aircraft/mdl_atr42_starter_v03.gltf` (+ `.bin`; `.fbx` editable source; v02/v01/v06 fallback) | Fictional ATR 42-600-class regional turboprop at 22.67 × 24.57 × 7.59 m: stocky high-wing fuselage with four fitted cockpit panes and credible pillars, even cabin windows, compact nacelles blended into the wing, fuselage-side main-gear sponsons, joined T-tail and six 3.93 m props; 183 named parts / 19,704 triangles; same envelope and moving-part names as v02 | Integrated for Emu Air / player under ADR 0051; 2026-09-15 controlled fidelity pass as v03 (v02 retained fallback); Hangar thumbnail regenerated; packaged overview/follow day/dusk/night QA pending |
