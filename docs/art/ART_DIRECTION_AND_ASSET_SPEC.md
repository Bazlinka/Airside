...
| AIR-005 | `Models/Aircraft/mdl_737_8_narrowbody_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded 737-8-class narrowbody at real reference scale: slender fuselage with fitted cabin glazing and pitched flight deck, low swept wing with dual-feather winglets, large forward-hung turbofans with chevron nozzles, deep wing-body fairing, joined conventional tail and tricycle gear; 204 named parts / 17,464 triangles; dedicated pick, shadow and follow framing profile | Integrated as the operational AI 737-8 VH-WTJ (fictional Wattlebird Jet) at Gate 13 under ADR 0047; 2026-09-15 visual revision in place (same path); Hangar thumbnail regenerated; packaged camera QA pending |
