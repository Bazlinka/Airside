...
| AIR-006 | `Models/Aircraft/mdl_dash8_q400_v01.gltf` (+ `.bin`; `.fbx` editable source) | Original unbranded Dash 8-400-class regional turboprop at 32.83 × 28.42 × 8.34 m: long high-wing fuselage, twin elongated nacelles, six-blade propellers, nacelle-mounted main gear and T-tail; 139 named parts / 6,728 triangles; dedicated pick, shadow and follow framing profile | Integrated for QantasLink's existing Dash 8-400 under ADR 0049; own 480 × 320 runtime-model thumbnail; Unity EditMode 328/328, packaged overview/follow day/dusk/night QA pending |
