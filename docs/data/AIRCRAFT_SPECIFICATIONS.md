...
| Regime | ATR 42 / Dash 8-400 / Saab 340B | Boeing 737-8 | Primary sources |
|---|---|---|---|
| Straight taxiway | 25 kt | 25 kt on long YPAD routes (FCTM normal ≈20; long clear ≤30) | ATR 42/72-500 PIA SOP max 25 kt straight (cited in AIAA *Journal of Aircraft* electric-taxi study, 2023); Saab 340 operator flow 25 kt taxiway; Boeing 737 FCTM Ch.2 *Taxi Speed and Braking*; regional-turboprop ADS-B study mean/median top ≈20 kt with 25 kt design target (same AIAA paper); CAST max 30 kt straight |
| Apron / ramp | 15 kt | 10 kt | Saab 340 operator flow (apron 15 kt); Boeing 737 FCTM ramp / apron entry ≈10 kt |
| Turns (≥~30°) | ≈10 kt (5–10 sharp / 180°) | ≈10 kt | Boeing 737 FCTM turn entry; CAST / airline SOPs |
| Stand lead-in | 5 kt | 5 kt | Marshaller / walking-pace guidance |
| Pushback (tug) | 3 kt | 3 kt | Walking-pace tow |
| Lineup onto runway | 10 kt | 10 kt | Boeing turn-entry band; leg ends stopped at roll start |
| Vacate after landing | settles to 20 kt after 12 kt runway exit | same (shared path) | Boeing “normal taxi ≈20 kt”; `CircuitProfile.RunwayExitKnots` |
