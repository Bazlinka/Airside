...
| Authored FBX turboprop + terminal v01 | Airside procedural (`generate-authored-fbx-turboprop-terminal.py`) | Distinct `*_authored_v01.fbx` (+ companion glTF): lathed fuselage / cylindrical engines; Unity ModelImporter source; Mac menu bakes Resources prefabs | Project-owned procedural FBX | None | `docs/art/prompts/authored-fbx-turboprop-terminal-2026-09-07.md`; PreferArtKit ahead of lofted/v04 | Integrated (glTF path); FBX prefab bake needs Mac |
