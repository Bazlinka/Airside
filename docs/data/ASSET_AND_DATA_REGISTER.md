...
| Batch E UI icon and panel candidates | OpenAI built-in image generation for Airside | Four transparent icon sheets and three UI panel/stripe textures; candidates only, not in a build | OpenAI service terms applicable at generation; release review required | None known | `docs/art/prompts/batch-e-ui-generation-2026-09-06.md`; generator/model, dimensions, processing, cost and fallback recorded there | Generated — review required |
