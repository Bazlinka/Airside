...
| BRD-001 Airside wordmark candidate | Airside project; deterministic Pillow generation | Transparent light wordmark with project-owned runway/wayfinding mark | Project-owned | None | `scripts/generate-airside-wordmark.py`; `docs/art/prompts/brand-and-splash-candidates-generation-2026-09-07.md` | Generated — review required; not in runtime |
| UI-ILL-001 dawn splash candidate | OpenAI built-in image generation for Airside | 3840×2160 splash candidate derived from approved Batch A references | OpenAI service terms applicable at generation; release review required | None known | `docs/art/prompts/brand-and-splash-candidates-generation-2026-09-07.md` | Generated — review required; not in runtime |
