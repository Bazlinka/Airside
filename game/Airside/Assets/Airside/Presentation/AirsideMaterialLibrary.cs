...
namespace Airside.Presentation
{
    ...
    public static class AirsideMaterialLibrary
    {
        ...
        private static readonly Dictionary<SurfaceKind, Profile> Profiles = new()
        {
            ...
            [SurfaceKind.Asphalt] = new Profile(0.012f, 0.14f, 0.68f, 0.88f),
            [SurfaceKind.Concrete] = new Profile(0.02f, 0.2f, 0.52f, 0.92f),
            [SurfaceKind.Grass] = new Profile(0.0f, 0.12f, 0.78f, 0.84f),
            [SurfaceKind.Sand] = new Profile(0.0f, 0.14f, 0.58f, 0.86f),
            [SurfaceKind.Metal] = new Profile(0.62f, 0.48f, 0.35f, 0.96f),
            [SurfaceKind.PaintedMetal] = new Profile(0.2f, 0.5f, 0.26f, 0.97f),
            [SurfaceKind.AircraftSkin] = new Profile(0.14f, 0.62f, 0.16f, 0.98f),
            [SurfaceKind.Glass] = new Profile(0.05f, 0.9f, 0.03f, 1f, transparent: true),
            [SurfaceKind.Rubber] = new Profile(0.015f, 0.1f, 0.7f, 0.86f),
            [SurfaceKind.Plastic] = new Profile(0.04f, 0.36f, 0.3f, 0.95f),
            [SurfaceKind.Water] = new Profile(0.02f, 0.92f, 0.2f, 1f, transparent: true),
