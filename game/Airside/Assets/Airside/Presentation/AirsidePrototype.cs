...
namespace Airside.Presentation
{
    public sealed class AirsidePrototype : MonoBehaviour
    {
        ...
        private static void BuildAirfield()
        {
            ...
            // Skip apron joint/slab densify — MAT concrete texture + soft wet residual carry the
            // read; greybox joints read as scattered blocks from landing/follow cameras.
        ...
        private static Transform BuildAircraft(string name, Color accent, string liveryDecalRelativePath = null)
        {
            ...
            // Prefer lofted silhouette for overview/follow readability; v05 remains next.
