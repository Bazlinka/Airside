...
namespace Airside.Simulation
{
    ...
    public readonly struct AircraftPerformanceProfile
    {
        ...
        /// <summary>Longitudinal distance from the runtime model's nose gear to the centre
        /// of its main gear, used to steer the visible wheels (not an invisible generic
        /// datum) through every ground turn. Measurements and source context are recorded
        /// in docs/data/AIRCRAFT_SPECIFICATIONS.md's ground taxi section.</summary>
    ...
    public static class AircraftPerformance
    {
        ...
        // Ground steering dimensions below are measured from the shipping runtime models,
        // so the simulated pivots agree with the landing gear the player can see.
        public static readonly AircraftPerformanceProfile Atr42 = new(
            120f, 110f, 95f, 104f, 120f, 160f, 900f, 6.6f, 6.1f,
            25000, 1200, 1500, 22f, 14f, 12f, 8.70f);
        ...
        // AIR-005's runtime nose/main gear centres are 15.30 m apart. Ground paths
        ...
        // Airbus A321 Aircraft Characteristics remains the external reference; the taxi
        // datum uses the shipping model's 17.25 m visible gear spacing.
        public static readonly AircraftPerformanceProfile AirbusA321Neo = new(
            155f, 140f, 128f, 145f, 165f, 210f, 1800f, 11.0f, 9.5f,
            39800, 1900, 1800, 20f, 10f, 15f, 17.25f);

        // The runtime gear and Airbus A350 characteristics agree at 28.66 m.
