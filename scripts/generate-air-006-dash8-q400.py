...
STATIONS = np.array(
    [
        ...
        (14.95, 0.73, 0.66, 1.64),
        (15.30, 0.58, 0.52, 1.54),
        (15.55, 0.42, 0.37, 1.45),
        (15.90, 0.24, 0.21, 1.37),
        (HALF_LENGTH - 0.12, 0.10, 0.09, 1.34),
    ],
    dtype=np.float32,
)
...
def q400_meshes():
    ...
    meshes["radome"] = oval_lathe_fuselage(
        [
            ...
            (15.05, 0.70, 0.62, 1.61),
            (15.40, 0.54, 0.47, 1.50),
            (15.75, 0.32, 0.28, 1.40),
            (HALF_LENGTH - 0.12, 0.11, 0.10, 1.34),
        ],
        segments=44,
    )
