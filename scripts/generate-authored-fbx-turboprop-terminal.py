...
def terminal_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    ...
    return {
        ...
        "landside_mullion_1": box(-4.0, 2.2, 2.4, 0.1, 1.9, 0.1),
        "landside_mullion_2": box(0.0, 2.2, 2.4, 0.1, 1.9, 0.1),
        "landside_mullion_3": box(4.0, 2.2, 2.4, 0.1, 1.9, 0.1),
        "landside_mullion_4": box(-2.0, 2.2, 2.4, 0.08, 1.9, 0.08),
        "landside_mullion_5": box(2.0, 2.2, 2.4, 0.08, 1.9, 0.08),
...
def ops_shed_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    return {
        ...
        "window_mullion_l": box(-1.8, 1.6, 2.08, 0.06, 0.9, 0.06),
        "window_mullion_r": box(1.8, 1.6, 2.08, 0.06, 0.9, 0.06),
        "window_sill_l": box(-1.8, 1.12, 2.08, 1.05, 0.08, 0.12),
        "window_sill_r": box(1.8, 1.12, 2.08, 1.05, 0.08, 0.12),
        "window_transom_l": box(-1.8, 2.0, 2.08, 1.0, 0.05, 0.05),
        "window_transom_r": box(1.8, 2.0, 2.08, 1.0, 0.05, 0.05),
...
def fuel_truck_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    return {
        ...
        "tank": cylinder(-0.45, 0.9, 0, 0.65, 2.5, axis="x", segments=14),
        ...
        "wheel_fl": cylinder(1.35, 0.28, 0.58, 0.28, 0.22, axis="z", segments=12),
        "wheel_fr": cylinder(1.35, 0.28, -0.58, 0.28, 0.22, axis="z", segments=12),
        "wheel_rl": cylinder(-1.15, 0.28, 0.58, 0.28, 0.22, axis="z", segments=12),
        "wheel_rr": cylinder(-1.15, 0.28, -0.58, 0.28, 0.22, axis="z", segments=12),
...
def baggage_tug_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    return {
        ...
        "wheel_fl": cylinder(4.0, 0.22, 0.5, 0.2, 0.18, axis="z", segments=10),
        "wheel_fr": cylinder(4.0, 0.22, -0.5, 0.2, 0.18, axis="z", segments=10),
        "wheel_rl": cylinder(3.2, 0.22, 0.5, 0.2, 0.18, axis="z", segments=10),
        "wheel_rr": cylinder(3.2, 0.22, -0.5, 0.2, 0.18, axis="z", segments=10),
        "cart_wheel_1l": cylinder(1.8, 0.18, 0.48, 0.16, 0.14, axis="z", segments=8),
        "cart_wheel_1r": cylinder(1.8, 0.18, -0.48, 0.16, 0.14, axis="z", segments=8),
        "cart_wheel_2l": cylinder(0.2, 0.18, 0.48, 0.16, 0.14, axis="z", segments=8),
        "cart_wheel_2r": cylinder(0.2, 0.18, -0.48, 0.16, 0.14, axis="z", segments=8),
        "cart_wheel_3l": cylinder(-1.4, 0.18, 0.48, 0.16, 0.14, axis="z", segments=8),
        "cart_wheel_3r": cylinder(-1.4, 0.18, -0.48, 0.16, 0.14, axis="z", segments=8),
...
def passenger_bus_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    return {
        ...
        "window_mullion_4": box(-2.0, 1.35, 0, 0.08, 0.55, 1.72),
        "window_mullion_5": box(2.0, 1.35, 0, 0.08, 0.55, 1.72),
        ...
        "wheel_fl": cylinder(1.45, 0.3, 0.72, 0.28, 0.24, axis="z", segments=12),
        "wheel_fr": cylinder(1.45, 0.3, -0.72, 0.28, 0.24, axis="z", segments=12),
        "wheel_rl": cylinder(-1.45, 0.3, 0.72, 0.28, 0.24, axis="z", segments=12),
        "wheel_rr": cylinder(-1.45, 0.3, -0.72, 0.28, 0.24, axis="z", segments=12),
...
def airfield_lighting_meshes() -> dict[str, tuple[np.ndarray, np.ndarray]]:
    ...
    return {
        ...
        "apron_floodlight": cylinder(0, 2.0, 0, 0.14, 4.0, axis="y", segments=10),
        ...
        "flood_pole": cylinder(0, 2.2, 0, 0.12, 4.2, axis="y", segments=12),
        "flood_brace": box(0.25, 3.2, 0, 0.5, 0.08, 0.08),
        "flood_brace_b": box(0.2, 2.4, 0, 0.4, 0.06, 0.06),
