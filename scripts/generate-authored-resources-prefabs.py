...
def main() -> None:
    ...
    emit_prefab(
        "mdl_operations_shed_authored_v01",
        "d4e5f60718293a4b5c6d7e8f901a2b3c",
        [
            ("shed_body", (0.0, 1.4, 0.0), (6.0, 2.8, 4.0), "cube"),
            ("porch", (0.0, 1.0, 2.3), (3.0, 2.0, 1.2), "cube"),
            ("porch_roof", (0.0, 2.15, 2.4), (3.4, 0.18, 1.5), "cube"),
            ("door", (0.0, 1.0, 2.85), (1.1, 1.9, 0.1), "cube"),
            ("window_l", (-1.8, 1.6, 2.05), (1.0, 0.9, 0.08), "cube"),
            ("window_r", (1.8, 1.6, 2.05), (1.0, 0.9, 0.08), "cube"),
            ("window_side", (-3.05, 1.6, 0.0), (0.08, 0.9, 1.4), "cube"),
            ("window_side_b", (3.05, 1.6, 0.0), (0.08, 0.9, 1.4), "cube"),
            ("roof_ridge", (0.0, 2.95, 0.0), (6.2, 0.25, 1.0), "cube"),
            ("roof_panel", (0.0, 2.85, 0.0), (6.0, 0.12, 3.8), "cube"),
            ("antenna_mast", (1.8, 3.6, -0.5), (0.1, 1.2, 0.1), "cylinder"),
            ("antenna_dish", (1.8, 4.15, -0.5), (0.45, 0.12, 0.45), "cylinder"),
            ("ac_unit", (-1.5, 3.15, -0.8), (1.2, 0.45, 0.9), "cube"),
            ("radio_rack", (-2.2, 1.4, -1.6), (0.8, 1.6, 0.5), "cube"),
            ("step", (0.0, 0.15, 2.9), (1.4, 0.25, 0.5), "cube"),
        ],
        base=(0.55, 0.58, 0.52),
        accent=(0.2, 0.4, 0.5),
        step=(0.48, 0.5, 0.46),
    ...
    emit_prefab(
        "mdl_fuel_truck_small_authored_v01",
        "e5f60718293a4b5c6d7e8f901a2b3c4d",
        [
            ("cab", (1.05, 0.95, 0.0), (1.5, 1.5, 1.55), "cube"),
            ("cab_window", (1.55, 1.25, 0.0), (0.08, 0.7, 1.2), "cube"),
            ("tank", (-0.45, 0.9, 0.0), (1.25, 2.5, 1.25), "cylinder", (0.0, 0.0, 90.0)),
            ("tank_band", (-0.45, 0.9, 0.0), (2.55, 0.2, 1.4), "cube"),
            ("wheel_fl", (1.35, 0.28, 0.58), (0.55, 0.55, 0.22), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_fr", (1.35, 0.28, -0.58), (0.55, 0.55, 0.22), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rl", (-1.15, 0.28, 0.58), (0.55, 0.55, 0.22), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rr", (-1.15, 0.28, -0.58), (0.55, 0.55, 0.22), "cylinder", (90.0, 0.0, 0.0)),
            ("Hose", (-1.55, 0.7, 0.75), (0.4, 0.4, 0.4), "cube"),
            ("hose_reel", (-1.55, 0.85, 0.35), (0.55, 0.55, 0.35), "cylinder", (90.0, 0.0, 0.0)),
            ("beacon", (1.05, 1.85, 0.0), (0.25, 0.2, 0.25), "cube"),
            ("bumper", (1.85, 0.4, 0.0), (0.2, 0.35, 1.4), "cube"),
        ],
        base=(0.92, 0.78, 0.18),
        accent=(0.25, 0.25, 0.28),
        step=(0.15, 0.15, 0.16),
    )
    emit_prefab(
        "mdl_baggage_tug_train_authored_v01",
        "f60718293a4b5c6d7e8f901a2b3c4d5e",
        [
            ("tug", (3.6, 0.55, 0.0), (1.7, 0.95, 1.15), "cube"),
            ("tug_cab", (4.1, 0.95, 0.0), (0.9, 0.85, 1.05), "cube"),
            ("cart_1", (1.8, 0.5, 0.0), (1.5, 0.75, 1.05), "cube"),
            ("cart_2", (0.2, 0.5, 0.0), (1.5, 0.75, 1.05), "cube"),
            ("cart_3", (-1.4, 0.5, 0.0), (1.5, 0.75, 1.05), "cube"),
            ("Cargo", (1.8, 0.95, 0.0), (1.2, 0.45, 0.85), "cube"),
            ("cargo_2", (0.2, 0.95, 0.0), (1.2, 0.45, 0.85), "cube"),
            ("cargo_3", (-1.4, 0.95, 0.0), (1.2, 0.45, 0.85), "cube"),
            ("wheel_fl", (4.0, 0.22, 0.5), (0.4, 0.4, 0.18), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_fr", (4.0, 0.22, -0.5), (0.4, 0.4, 0.18), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rl", (3.2, 0.22, 0.5), (0.4, 0.4, 0.18), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rr", (3.2, 0.22, -0.5), (0.4, 0.4, 0.18), "cylinder", (90.0, 0.0, 0.0)),
            ("beacon", (4.1, 1.5, 0.0), (0.2, 0.15, 0.2), "cube"),
        ],
        base=(0.91, 0.38, 0.12),
    ...
    emit_prefab(
        "mdl_passenger_bus_apron_authored_v01",
        "0718293a4b5c6d7e8f901a2b3c4d5e6f",
        [
            ("bus_body", (0.0, 0.95, 0.0), (4.4, 1.65, 1.65), "cube"),
            ("cabin_roof", (0.0, 1.9, 0.0), (4.2, 0.28, 1.55), "cube"),
            ("windows", (0.0, 1.35, 0.0), (3.8, 0.55, 1.7), "cube"),
            ("Door", (0.25, 0.95, 0.85), (1.05, 1.35, 0.1), "cube"),
            ("bumper_front", (2.25, 0.45, 0.0), (0.25, 0.45, 1.5), "cube"),
            ("bumper_rear", (-2.25, 0.45, 0.0), (0.25, 0.45, 1.5), "cube"),
            ("wheel_fl", (1.45, 0.3, 0.72), (0.55, 0.55, 0.24), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_fr", (1.45, 0.3, -0.72), (0.55, 0.55, 0.24), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rl", (-1.45, 0.3, 0.72), (0.55, 0.55, 0.24), "cylinder", (90.0, 0.0, 0.0)),
            ("wheel_rr", (-1.45, 0.3, -0.72), (0.55, 0.55, 0.24), "cylinder", (90.0, 0.0, 0.0)),
            ("beacon", (0.0, 2.15, 0.0), (0.28, 0.2, 0.28), "cube"),
            ("step", (0.25, 0.35, 0.95), (0.9, 0.15, 0.35), "cube"),
        ],
        base=(0.17, 0.58, 0.78),
        accent=(0.2, 0.4, 0.55),
        step=(0.15, 0.15, 0.16),
