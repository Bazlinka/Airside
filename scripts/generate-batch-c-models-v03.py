#!/usr/bin/env python3
"""Generate richer Batch C v03 metre-scale glTF kits (decision 0025 item 2).

Same POSITION+indices box format as ArtGltfLoader. Does not overwrite v01/v02 —
writes sibling *_v03.gltf/.bin + .meta. More segmented parts for silhouette
...
def main() -> None:
    pack_gltf(
        ROOT / "Models" / "Aircraft" / "mdl_regional_turboprop_01_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Buildings" / "mdl_terminal_regional_small_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Buildings" / "mdl_hangar_small_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Buildings" / "mdl_operations_shed_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Vehicles" / "mdl_fuel_truck_small_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Vehicles" / "mdl_baggage_tug_train_v03.gltf",
        {
    ...
    pack_gltf(
        ROOT / "Models" / "Vehicles" / "mdl_passenger_bus_apron_v03.gltf",
        {
    ...
    print("Batch C v03 kits written under", ROOT)
