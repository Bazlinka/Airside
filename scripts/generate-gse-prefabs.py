...
def main() -> None:
    ...
    emit_prefab(
        ...
        [
            ...
            ("Chock L wedge", (-0.55, 0.08, 0.12), (0.32, 0.12, 0.22)),
            ("Chock R wedge", (0.55, 0.08, 0.12), (0.32, 0.12, 0.22)),
            ("Chock L rope", (-0.55, 0.18, -0.05), (0.08, 0.08, 0.35)),
            ("Chock R rope", (0.55, 0.18, -0.05), (0.08, 0.08, 0.35)),
            ("Chock L stripe", (-0.55, 0.05, 0.0), (0.38, 0.06, 0.12)),
            ("Chock R stripe", (0.55, 0.05, 0.0), (0.38, 0.06, 0.12)),
            ("Chock link", (0.0, 0.12, -0.15), (0.9, 0.05, 0.05)),
            ("Chock handle", (0.0, 0.22, -0.15), (0.25, 0.08, 0.08)),
        ],
        base=(0.85, 0.2, 0.15),
    ...
    emit_prefab(
        ...
        [
            ...
            ("GPU cab", (0.45, 0.25, 0.0), (0.55, 0.55, 0.8)),
            ("GPU cable", (0.85, 0.1, 0.0), (0.7, 0.08, 0.08)),
            ("GPU cable coil", (0.95, 0.25, 0.15), (0.25, 0.25, 0.25)),
            ("GPU plug", (1.2, 0.1, 0.0), (0.12, 0.12, 0.18)),
            ("GPU wheel L", (0.4, -0.28, 0.35), (0.22, 0.22, 0.14)),
            ("GPU wheel R", (0.4, -0.28, -0.35), (0.22, 0.22, 0.14)),
            ("GPU wheel RL", (-0.4, -0.28, 0.35), (0.22, 0.22, 0.14)),
            ("GPU wheel RR", (-0.4, -0.28, -0.35), (0.22, 0.22, 0.14)),
            ("GPU accent vent", (0.0, 0.35, 0.0), (1.1, 0.12, 0.7)),
            ("GPU grille", (-0.5, 0.15, 0.46), (0.5, 0.35, 0.06)),
            ("GPU panel", (0.2, 0.2, 0.46), (0.45, 0.4, 0.05)),
            ("GPU handle", (-0.7, 0.35, 0.0), (0.08, 0.35, 0.5)),
            ("GPU beacon", (0.45, 0.6, 0.0), (0.14, 0.14, 0.14)),
            ("GPU hitch", (-0.75, -0.05, 0.0), (0.25, 0.12, 0.12)),
        ],
        base=(0.25, 0.55, 0.35),
